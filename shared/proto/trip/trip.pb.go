...
type PreviewTripResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TrpID         string                 `protobuf:"bytes,1,opt,name=trpID,proto3" json:"trpID,omitempty"`
...
func (x *PreviewTripResponse) GetTrpID() string {
	if x != nil {
		return x.TrpID
	}
	return ""
...
const file_trip_proto_rawDesc = "" +
	...
	"\x13PreviewTripResponse\x12\x14\n" +
	"\x05trpID\x18\x01 \x01(\tR\x05trpID\x12!\n" +
